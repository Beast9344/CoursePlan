        ...
        {module.status !== 'not-started' && (
          <div>
            <div className="flex justify-between items-center mb-1">
              ...
              <p className={`text-xs font-bold ${statusStyles[module.status].textColor}`}>{module.progress}%</p>
            </div>
         ...
         {module.status === 'not-started' && (
           <p className="text-sm text-muted-foreground italic">Get started with this module!</p>
         )}
      </CardContent>
      <CardFooter>
